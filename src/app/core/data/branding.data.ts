...
export const SAQR_BRANDING: SaqrBrandingStructure = {
  ...
  ecosystem: {
    ...
    description: 'The future belongs to those who move first. SAQR brings every signal into sharp focus so you can make the move before it becomes obvious.',
  ...
  meta: {
    ...
    description: 'SAQR turns complex on-chain data into decisive action. Sharp intelligence built for the next generation of Web3 builders.',
    themeColor: '#0b0d0c',
  },
