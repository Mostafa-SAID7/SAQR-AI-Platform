...
export const PLATFORM_SUBSECTION = {
  ...
  description:
    'Connect your data sources once. SAQR continuously scans markets, communities, protocols, and transactions to surface the moments that matter.',
};
...
export const ECOSYSTEM_SECTION: ContentSection = {
  ...
  description:
    'SAQR is designed to connect the builders, protocols, and communities moving the network forward.',
};

export const ECOSYSTEM_NETWORK = {
  heading: 'Everything connected.',
  description:
    'From your first signal to your final execution, SAQR keeps the whole loop visible. Build alongside a network that gets more useful with every connection.',
...
export const ECOSYSTEM_TRUST = {
  ...
  description:
    'Your data belongs to you. Role-based access, encrypted connections, and transparent permissions keep every action accountable.',
};
...
export const GET_STARTED_SECTION: ContentSection = {
  ...
  description:
    "Join the early access network and see what's possible when sharp intelligence meets the open internet.",
};
...
export const NOT_FOUND_PAGE: ContentSection = {
  heading: 'Signal lost.',
  description:
    'This route is outside the current network. Return to the command center or continue exploring the SAQR intelligence layer.',
};
...
export const PLATFORM_PAGE = {
  ...
  description:
    'One command center for every signal, strategy, and smart action across the open network.',
...
export const INSIGHTS_PAGE = {
  ...
  description:
    'Ideas, frameworks, and field notes from the people building at the edge of the network.',
  fieldNote: {
    title: 'The new interface is intelligence.',
    description:
      'Why the next generation of Web3 products will be defined by the quality of their context, not the number of features on the screen.',
  },
  readMoreItems: [
...
export const AGENTS_PAGE = {
  ...
  description:
    'Specialized intelligence that learns your context, watches the network, and acts with permission.',
  subheading: 'Choose your point of view.',
  subDescription:
    'Every agent is purpose-built. Combine them to create a decision system that feels like your unfair advantage.',
